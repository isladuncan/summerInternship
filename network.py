...
def graph_configuration():
    ...
    G.add_edge(2, 13, id = 3, length = random.randint(10, 1000))
    G.add_edge(3, 4, id = 5, length = random.randint(10, 1000))
    G.add_edge(4, 5, id = 6, length = random.randint(10, 1000))
    G.add_edge(5, 13, id = 7, length = random.randint(10, 1000))
    G.add_edge(6, 7, id = 9, length = random.randint(10, 1000))
    G.add_edge(7, 8, id = 10, length = random.randint(10, 1000))
    G.add_edge(8, 12, id = 11, length = random.randint(10, 1000))
    G.add_edge(9, 10, id = 13, length = random.randint(10, 1000))
    G.add_edge(10, 11, id = 14, length = random.randint(10, 1000))
    G.add_edge(11, 12, id = 15, length = random.randint(10, 1000))
    G.add_edge(12, 13, id = 16, length = random.randint(10, 1000))
